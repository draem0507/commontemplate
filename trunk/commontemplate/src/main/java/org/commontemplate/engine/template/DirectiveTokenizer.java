...
final class DirectiveTokenizer {
	...
	private static final int states[][] = {
		...
		/* 6.不解释块*/ { 6, 18, 6, 6, 6, 6, 10, 6, 6, 6, 6, 6, 6, 6}, // 不解释块特殊指令识别
		/* 7.块注释  */ { 7, 19, 7, 7, 7, 7, 7, 11, 7, 7, 7, 7, 7, 7}, // 块注释特殊指令识别
		...
		/*13.转义12 */ { 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12}, // 双引号字符串转义
		/*14.单引号  */ { 14, 15, 14, 14, 14, 14, 14, 14, 14, 14, 14, 5, 14, 14}, // 绕过表达式中的单引号字符串(不解析字符串中的内容)
		/*15.转义14 */ { 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14}, // 单引号字符串转义
		/*16.反单引号*/ { 16, 17, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 5, 16}, // 绕过表达式中的反单引号字符串(不解析字符串中的内容)
		/*17.转义16 */ { 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16}, // 反单引号字符串转义
		/*18.转义6  */ { 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6}, // 块注释结束符转义, 如: $* \*$ *$
		/*19.转义7  */ { 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7} // 不解释块结束符转义, 如: $! \!$ !$
	};
