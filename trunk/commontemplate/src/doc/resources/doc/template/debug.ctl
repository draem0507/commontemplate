<!--$extends{"/doc/template/frame.ctl"}-->
	<!--$overzone{"content"}-->
								<b>1. $msg{'page.debug.function'}:</b><br/>
								$msg{'page.debug.function.desc'}<br/>
								<br/>
								<b>2. $msg{'page.debug.breakpoint'}:</b><br/>
								(1) $msg{'page.debug.breakpoint.trigger'}<br/>
								(2) $msg{'page.debug.breakpoint.directive'}<br/>
								(3) $msg{'page.debug.breakpoint.swing'}<br/>
								<br/>
								<b>3. $msg{'page.debug.buttons'}:</b><br/>
