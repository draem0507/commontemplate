...
$!
								...
								(4) org.commontemplate.standard.coat.attribute.jericho.JerichoAttributeCoatFilter依赖于jericho.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;影响：属性语法外套<br/>
								(5) org.commontemplate.standard.directive.filter.code.JavaCodeFilter依赖于java2html.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;影响：指令：$code{java}<br/>
								(6) org.commontemplate.standard.directive.taglib.TagLineDirectiveAdapter/TagBlockDirectiveAdapter依赖于servlet-api.jar包和jsp-api.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;org.commontemplate.standard.directive.taglib.PageContextImpl依赖于commons-el.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;影响：JspTagLib指令适配<br/>
								(7) org.commontemplate.util.JSONUtils依赖于json.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;影响：指令：$data{json} 扩展属性：${obj.toJson} ${"{name:\"kent\"}".fromJson}<br/>
								(8) org.commontemplate.standard.data.YamlDataProvider依赖于jyaml.jar包<br/>
								&nbsp;&nbsp;&nbsp;&nbsp;影响：指令：$data{yaml}<br/>
								(9) org.commontemplate.standard.property.object.ObjectToXstreamPropertyHandler和org.commontemplate.standard.property.string.StringFromXstreamPropertyHandler依赖于xstream.jar包<br/>
