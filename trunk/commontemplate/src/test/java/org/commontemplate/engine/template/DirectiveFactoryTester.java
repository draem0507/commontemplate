...
public class DirectiveFactoryTester extends TestCase {
	...
	public void testNullDirective() throws IOException, ParsingException {
		Element directive = directiveFactory.getDirective(new Token("$if{true}", 1, new Position(10, 12)), false);
		super.assertEquals("if", directive.getName());
		super.assertEquals(new Location(10, 12, 10, 21), directive.getLocation());
	}
