...
/**
 * ArrayGetterOperatorHandler 的测试。
 * @author YanRong
 *
 */
public class ArrayGetterOperatorHandlerTester extends TestCase {

	BinaryOperatorHandler handler;
	
	protected void setUp() throws Exception {
		handler = new ArrayGetterOperatorHandler();
	}
	...
	public void testDoEvaluateASC() throws Exception {
		...
		String result = (String)handler.doEvaluate(strs, new Integer(2));
	...
	public void testOverBound() throws Exception {
		...
		String[] strs = new String[]{"a", "b", "c", "d"};
		String result = (String)handler.doEvaluate(strs, new Integer(-4));
		assertNull(result);
		result = (String)handler.doEvaluate(strs, new Integer(4));
		assertNull(result);
	}
