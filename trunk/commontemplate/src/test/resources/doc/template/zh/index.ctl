<!--$extends{"/doc/template/frame.ctl"}-->
	<!--$overzone{"content"}-->
								...
								1. 只有一个语法规则：\$指令名{表达式}，使用更简单，更统一。<a href="template.html">更多...</a><br/>
								2. 强大的调试功能，支持模板指令单步执行，使开发时查错更方便。<a href="debug.html">更多...</a><br/>
								...
								9. 禁止函数调用，避免在模板中引入业务逻辑。(允许配置开启非void函数调用)<br/>
								10. 对已有的不可变类(String,Number,Date等)，采用open class思想，允许在类的外部给类添加新的属性或方法，如String本没有“首字母大写”的功能，可以外部给String注册一个capital属性：\${"james".capital}。(类似javascript的prototype)<br/>
								...
								15. 站在巨人的肩膀上，参考并借鉴了WebMacro, Velocity, FreeMarker, Perl6, Python/Django, PHP/Smarty, JavaScript/JSON, OGNL, XPath 等开源项目或规范，在这里感谢它们做出的成果。<br/>
								<br/>
