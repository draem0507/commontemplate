<!--$extends{"/doc/template/frame.ctl"}-->
	<!--$overzone{"content"}-->
$!
								<b>一、发行版本</b> <a href="news.html">更新日志...</a><br/>
								...
								(7) struts-commontemplate-plugin-SNAPSHOT.jar 与<a href="http://struts.apache.org/2.x/" target="_blank">Struts2</a>的集成包，采用Struts2约定的插件方式打包<br/>
