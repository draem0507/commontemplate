<!--$extends{"/doc/template/frame.ctl"}-->
	<!--$zone{"content"}-->
$!
								<b>一、发行版本</b> (当前版本0.8.6) <a href="changes.html">更新日志...</a><br/>
								...
								(7) commontemplate-javascript-x.x.jar 与<a href="http://java.sun.com/javase/6/docs/api/javax/script/package-summary.html" target="_blank">javax.script</a>的集成包，采用javax.script约定的自发现方式打包 <a href="javaxscript.html">集成说明...</a><br/>
								...
								(5) commontemplate-javascript-SNAPSHOT.jar 与<a href="http://java.sun.com/javase/6/docs/api/javax/script/package-summary.html" target="_blank">javax.script</a>的集成包，采用javax.script约定的自发现方式打包 <a href="javaxscript.html">集成说明...</a><br/>
								<font color="green">(注：每日构建版本可以使用所有最新功能特性，但也可能出现不稳定问题)</font><br/>
								<br/>
								<b>三、源码控制 (SVN)</b><br/>
								<table border="0" cellpadding="2" cellspacing="0">
									<tr>
										<td height="31"><a target="_blank" href="http://commontemplate.googlecode.com/svn/trunk/commontemplate" target="_blank"><img src="../images/google_code.gif" border="0" width="88" height="31" /></a></td>
										<td><a target="_blank" href="http://commontemplate.googlecode.com/svn/trunk/commontemplate" target="_blank">http://commontemplate.googlecode.com/svn/trunk/commontemplate</a></td>
									</tr>
								</table>
								<font color="green">(注：在SVN中，匿名Checkout以上URL即可)</font><br/>
								<br/>
!$
	<!--$end-->
<!--$end-->