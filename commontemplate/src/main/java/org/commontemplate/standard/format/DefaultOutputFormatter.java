...
public class DefaultOutputFormatter implements OutputFormatter, Serializable {
	...
	private OutputFormatter booleanFormatter;

	public void setBooleanValue(String value) {
		this.booleanFormatter = new BooleanFormatter(value);
	}
	...
	public String format(Object model, Locale locale, TimeZone timeZone) throws UnformattedException {
		...
		} else if (model instanceof Boolean && booleanFormatter != null) {
			return booleanFormatter.format(model, locale, timeZone);
